...
export class MyMcpClient {
  ...
  public doResult = (toolName: string, toolResult: CallToolResult): any => {
    let callResult: any;
    if (!toolResult) {
  ...
  public callTool = async (toolName: string, data: any, options?: RequestOptions, client?: Client): Promise<any> => {
